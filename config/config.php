...
if (!defined('PROJECT_PATH')) {
    define('PROJECT_PATH', 'http://localhost/php/ecom'); // Replace this value with your project path
}
...
if (!defined('STORE_ID')) {
    define('STORE_ID', 'na5f8476203e255');
}

if (!defined('STORE_PASSWORD')) {
    define('STORE_PASSWORD', 'na5f8476203e255@ssl');
}
